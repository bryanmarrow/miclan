...
$title = isset($_GET['title'])? $_GET['title'] : 'Mi cuenta - '.$nombreEvento.' - '.$descripcionEvento.' #'.$tagEvento.'';
...
if($global==0){
    ...
    $page=empty($_SESSION) ? 'pages/login.inc.php' : 'pages/inscripciones.inc.php';
