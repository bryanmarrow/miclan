...
$title = isset($_GET['title'])? $_GET['title'] : 'Liquida tu pase - '.$nombreEvento.' - '.$descripcionEvento.' #'.$tagEvento.'';
...
$ogtitle = isset($_GET['ogtitle'])? $_GET['ogtitle'] : 'Liquida tu pase - '.$nombreEvento.' - '.$descripcionEvento.' #'.$tagEvento.'';
...
if($global==0){
    ...
    $page=$statusForm==1 ? OFFLINE_PAGE : 'pages/liquidar-pase.inc.php'; 
