...
$title = isset($_GET['title'])? $_GET['title'] : 'Editar mi cuenta - '.$nombreEvento.' - '.$descripcionEvento.' #'.$tagEvento.'';
...
if($global==0){
    ...
    $page=empty($_SESSION) ? 'pages/login.inc.php' : 'pages/edit-account.inc.php';
