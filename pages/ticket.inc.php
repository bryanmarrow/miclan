            ...
            <div class="d-flex flex-column h-100 bg-light rounded-lg box-shadow-lg p-4">
              <div class="py-2 p-md-3">
                ...
                <div class="d-sm-flex align-items-center justify-content-between pb-4 text-center text-sm-left">
                    <h1 class="h3 mb-2 text-left"><?php if($dataPase['status_apartado']==0 && $status_apartado==0){ ?>Apartado - <?php } ?><?= $nombreTicket ?></h1>
                ...
                <form class="needs-validation" id="formTickets" data-form='<?= $form ?>' data-tipoForm='acceso' novalidate>
                    <div class="row">
                        <?php require($rootPath.'componentes/tickets.php') ?>
