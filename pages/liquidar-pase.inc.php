            ...
            <div class="d-flex flex-column h-100 bg-light rounded-lg box-shadow-lg p-4">
              <div class="py-2 p-md-3">
                ...
                <div class="d-sm-flex align-items-center justify-content-between pb-4 text-center text-sm-left">
                    <h1 class="h3 mb-2 text-nowrap">Liquida tu pase</h1>
                ...
                <form class="needs-validation" id='formLiquidarOrden' novalidate>
                    <div class="row">
                        <?php require($rootPath.'componentes/form_liquidacion.php') ?>
                        <?php require($rootPath.'componentes/checkout_res.php') ?>
                    </div>
                </form>
                </div>
              </div>
