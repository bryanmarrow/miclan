...
$title = isset($_GET['title'])? $_GET['title'] : 'Registro Grupos - '.$nombreEvento.' - '.$descripcionEvento.' #'.$tagEvento.'';
...
if($global==0){
    ...
    $page=$statusForm==0 ? 'pages/registro-grupo.inc.php' : OFFLINE_PAGE;
