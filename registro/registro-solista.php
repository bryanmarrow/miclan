...
$title = isset($_GET['title'])? $_GET['title'] : 'Registro Solistas - '.$nombreEvento.' - '.$descripcionEvento.' #'.$tagEvento.'';
...
$ogtitle = isset($_GET['ogtitle'])? $_GET['ogtitle'] : 'Registro Solistas - '.$nombreEvento.' - '.$descripcionEvento.' #'.$tagEvento.'';
...
if($global==0){
    ...
    $page=$statusForm==0 ? 'pages/registro-solista.inc.php' : OFFLINE_PAGE;    
